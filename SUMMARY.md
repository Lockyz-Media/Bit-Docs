...
* [Create Plugins](dev/create-plugins/README.md)
  ...
  * [Functions](dev/create-plugins/functions/README.md)
    * [Plugin Functions](dev/create-plugins/functions/plugin-functions.md)
    * [Bit Core Functions](dev/create-plugins/functions/bit-core-functions/README.md)
      * [Logs](dev/create-plugins/functions/bit-core-functions/logs.md)
